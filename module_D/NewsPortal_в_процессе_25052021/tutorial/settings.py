...
# для регистрации нового пользователя через allauth
...
ACCOUNT_EMAIL_REQUIRED = True  # Адрес электронной почты, необходимый для активации
ACCOUNT_UNIQUE_EMAIL = True
ACCOUNT_USERNAME_REQUIRED = False
ACCOUNT_AUTHENTICATION_METHOD = 'email'
ACCOUNT_EMAIL_VERIFICATION = 'none' # не отправлять подтверждение по электронной почте

ACCOUNT_LOGIN_ATTEMPTS_LIMIT = 10 #Предел попыток входа в систему

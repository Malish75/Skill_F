...
from .views import NewsList, NewsDetail, SearchNewsList, NewsCreateView, NewsUpdateView, NewsDeleteView, subscribe_me, unsubscribe_me, CategoryList # импортируем наше представление
​
urlpatterns = [

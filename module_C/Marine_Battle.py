"""
по-сути, это плагиат кода из вебинара, т.к. на данном этапе своими мозгами я
эту игру буду писать месяц наверное.
сложновато для первой программы на классы, вобще-то, а?
"""
...
class Board:
    def __init__(self, hid=False, size=6):
        ...
        self.field = [["O" for r in range(1, size + 1)] for k in range(1, size + 1)]
    ...
    def __str__(self):
        ...
        if self.hid:
            res = res.replace("■", "O")  # скрывает символы корабля с доски
        return res
